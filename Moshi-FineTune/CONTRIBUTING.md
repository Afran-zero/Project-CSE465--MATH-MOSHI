# Contributing to Moshi-Finetune

## Pull Requests

Moshi-Finetune is the implementation of a research paper.
...
3. Accept the Contributor License Agreement (see after).
...
By contributing to Moshi-Finetune, you agree that your contributions will be licensed
under the LICENSE file in the root directory of this source tree. This project
